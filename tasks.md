...
- [done] AUT-OPS-01 - Install and expose the canonical `autonomy` console script so operator/planner skills can use `autonomy ...` directly without repo-local module fallback.
